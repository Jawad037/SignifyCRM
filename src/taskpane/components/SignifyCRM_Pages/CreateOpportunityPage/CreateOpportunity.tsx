...
import AccountInput from '../../SignifyCRM_UI/SignifyCRM_Inputs/AccountInput'
...
import CurrencySelect from '../../SignifyCRM_UI/Signify_DropDown/CurrencySelect'
    ...
    return (
        ...
        <>
            ...
            >
                ...
                {/* <AccountInput onChange={(value) => handleInputChange('account', value)} /> */}
                <GetAccountByNameAPI />
                <TypeSelect onChange={(value) => handleInputChange('type', value)} />
                {/* <SaleStageSelect onChange={(value) => handleInputChange('salesstage', value)} /> */}
                <SaleStageSelect value={formData.salesstage} onChange={handleSaleStageChange} />

                {/* <CurrencySelect onChange={(value) => handleInputChange('currency', value)} /> */}
                <SignifyCurrency />
                ...
                {/* <ProbabilityInput onChange={(value) => handleInputChange('probability', value)} /> */}
            ...
            {/* <SignifyToast open={toastOpen} setOpen={setToastOpen} message={toastMessage} /> */}
