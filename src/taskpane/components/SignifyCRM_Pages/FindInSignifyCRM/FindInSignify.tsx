...
import ContactList from '../../SignifyCRM_UI/SignifyCRM_Lists/ContactList'
import AccountList from '../../SignifyCRM_UI/SignifyCRM_Lists/AccountList'
import OpportunityList from '../../SignifyCRM_UI/SignifyCRM_Lists/OpportunityList'
import LeadList from '../../SignifyCRM_UI/SignifyCRM_Lists/LeadList'
...
const FindInSignify = () => {
    ...
    return (
        <>
            ...
            {/* <CRM_Loader open={loading || loadingAccounts || loadingOpportunities || loadingLeads || loadingContacts} /> */}
